...
const BackToTopButton = () => {
    ...
    return (
        <button
            ...
            onClick={returnToTop}
            className="w-12 h-12 xs:fixed right-2 xs:right-5 md:right-8 bottom-12 justify-center items-center text-white rounded-full border border-neutral-900 hover:border-zinc-500 transition duration-300 z-10"
        >
