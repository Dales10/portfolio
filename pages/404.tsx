...
const PageNotFound = () => {
    ...
    return (
        ...
        >
            ...
            >
                O caminho "{page}" não resulta em nenhuma página existente, ou,
                a mesma não está funcionando no momento. Por favor, verifique se
                o caminho realmente é de uma página existente, caso contrário,
                volte mais tarde.
            </h1>
        </div>
    );
